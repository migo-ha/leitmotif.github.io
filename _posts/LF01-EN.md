...
Yet infrastructure does not imply identity and it is rarely articulated what this system constitutes---in particular, when it is not measured against external reference points. Too often, discussion remains stuck in comparison.

#### II.
*Leitmotif* assumes that this identity exists. It might not always be explicitly verbalized, but it is embedded in how artists and scenes function, and persist over time.

This publication is concerned with this internal logic---not just as mythology or aesthetic, but as an operating system of relationships and practices.

![Christopher Schmidt with Giver](/assets/images/LF01/cs_patschmidt.jpg "Christopher Schmidt with Giver")
...
#### Coda
*[Arnold Schönberg --- Verklärte Nacht, Opus 4, IV. Adagio (Bar 229)](https://www.youtube.com/watch?v=I8qqGg5PPOE)*